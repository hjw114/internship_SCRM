...
def train(path,detector):
    ...
    recog.save(r'E:\My Documents\GitHub\web\model\trainer.yml')

if __name__ == '__main__':
    path = 'D:/internship_SCRM/face/face'
    detector = cv2.CascadeClassifier(
        r'C:\Users\ASUS\AppData\Local\Programs\Python\Python37\Lib\site-packages\cv2\data\haarcascade_frontalface_default.xml')  # 调用人脸分类器
    train(path,detector)